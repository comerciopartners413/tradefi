                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right hide" style="line-height: 14px">
                            ...
                            <div class="header-title">
                                <h3>Stanbic Price Log</h3>
                                <small>List of all prices provided by stanbic.
                            </small>
                            </div>
                        </div>
                        <hr>
                                                ...
                                                @foreach($pricelogs as $log)
                                                  @if($log->ProductID ==  1)
                                                     <tr>
                                                      ...
                                                      <td>{{ number_format($log->BuyPrice, 2) }}</td>
                                                      <td>{{ number_format($log->SellPrice, 2) }}</td>
                                                      <td>{{ \Carbon\Carbon::parse($log->Date)->toDayDateTimeString() }}</td>
                                                    </tr>
                                                  @endif
                                                @endforeach
                                              </tbody>
