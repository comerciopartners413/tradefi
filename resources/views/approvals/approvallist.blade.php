    ...
    <div class="panel panel-filled">
            ...
            <div class="panel-body">
                <table class="table" id="tableExample4">
                        ...
                        <tbody>
                           @foreach($securities as $td)
                            <tr>
                                  <td>
                                                    <div class="checkbox check-info">
                      <input type="checkbox" id="select-all-child-{{ $td->SecurityRef }}" class="select-all-child" value="{{ $td->SecurityRef }}">
                      <label for="select-all-child-{{ $td->SecurityRef }}" class="text-white"></label>
                    </div>
                                                </td>
...
$(function(){
 ...
 $('.approve-btn').click(function(e) {
   ...
   var ApproverID = {{ auth()->user()->id }};
     alert('Are You sure you want to approve this trade?');
