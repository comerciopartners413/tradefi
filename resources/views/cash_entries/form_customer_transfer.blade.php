    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="controls">
                ...
                {{ Form::select('GLIDCredit', [ '' =>  'Select Customer Account'] + $customer_details->pluck('CUST_ACCT', 'GLRef')->toArray(),null, ['class'=> "full-width select2 select2_demo_1 form-control", 'data-init-plugin' => "select2"]) }}
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    {{ Form::hidden('PostingTypeID', 6, ['class' => 'form-control', 'placeholder' => 'Account Type']) }}
