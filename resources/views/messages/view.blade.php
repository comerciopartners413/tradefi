...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-md-9">
      ...
      <div class="panel panel-filled" style="color: #ccc">
        <div class="panel-body">
          <div class="clearfix">
            <h4 class="m-t-0 m-b-20 semi-bold pull-left">{{ $message->Subject }}</h4>
            <a href="{{ route('compose_message') }}/?forward={{ $message->MessageRef }}" class="btn btn-sm btn-inverse pull-right" style="color:#ccc"><i class="fa fa-share m-r-5"></i>Forward</a>
          </div>
            ...
            <form action="{{ route('reply_message', $message->MessageRef) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="clearfix m-t-30 m-b-20">
                  ...
                  <button type="submit" class="pull-right btn btn-lg btn-info"><i class="fa fa-paper-plane m-r-5"></i> Reply</button>
                </div>
    ...
    $('#add_file').on('click', function(){
      ...
      files.append(`
        <li class="row m-t-5 clearfix">
          ...
          <i class="fa fa-times-circle text-danger delete f22 cursor_pointer" style="font-size:22px;float: right"></i>
        </li>
        `);
    });
