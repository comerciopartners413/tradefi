                ...
                <div class="row" align="center">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="layout-slider">
                            <input id="Slider2" type="slider" class="smartinput form-control text-center" name="price" value=""  />
                        </div>
...
; padding: 10px; border-radius: 10px;" id="sc">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select id="benchmark-selector" class="select2_demo_1 form-control" style="width: 30%">
        ...
        $("#select_sec_type").change(function(e) {
            ...
            $('#sc').show();
                ...
                $('#easy-mode-search-button').click(function(e) {
                    ...
                    var LengthOfInvestment = $("#benchmark-selector").val();
                    $.ajax({
                        url: '/trade-room/fetch-easy',
                        type: 'POST',
                        data: {
                            Amount: $('[name=price]').val(),
                            ProductID: 1,
