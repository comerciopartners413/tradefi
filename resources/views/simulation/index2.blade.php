...
@section('content')
 ...
 <div class="container-fluid" id="normalmodediv" style="/*position:fixed;margin-right:inherit */">
                <div class="row">
               {{ Form::open(['action' => 'TradeRoomController@search']) }}
                    <div class="col-md-3">
                            ...
                            @foreach($securities as $sec)
                                ...
                                <div class="panel panel-filled " style="border-radius:10px;">
                                    <div class="panel-body">
                                        ...
                                        <h4 class="m-t-none"><a href="#">{{ $sec->Description }}</a></h4>
            ...
            <div class="v-timeline vertical-container scrollbar" id="style-1" style="height: 700px;overflow-x: hidden; overflow-y: scroll;">
                <div class="vertical-timeline-block">
                    ...
                    <div class="vertical-timeline-content tradeCard">
                        <div class="p-sm">
                            <span class="vertical-date pull-right"> <small>5hrs ago</small> </span>

                            <h2><b>Increase in Openings</b></h2>

                            <div class="row">
                                <div class="col-md-4 " align="center">

                                    <h5 class="m-b-none server1">Security</h5>

                                    <h3><span style="color:#fff" class="usage21">53%</span></h3>
                                    <h4 class="m-b-none server1"><span style="color:#8CCA1D">BUY</span></h4>

                                </div>
                                <div class="col-md-8" style="color:#fff" align="center">Growth in Opening positions in the last 20minutes, 53% were <span style="color:#46be8a">BUY</span></div>
                        ...
                        <div class="p-sm">
                            ...
                            <div class="row">
                                <div class="col-md-4 " align="center">
                                    ...
                                    <h3><span style="color:#fff" class="usage23">62%</span></h3>
                                    <h4 class="m-b-none server1"><span style="color:#E35B5A">SELL</span></h4>

                                </div>
                                <div class="col-md-8" style="color:#fff" align="center">Growth in Opening positions in the last 20minutes, 53% were <span style="color:#E35B5A">SELL</span></div>
                        ...
                        <div class="p-sm">
                            ...
                            <div class="row">
                                <div class="col-md-4 " align="center">
                                    ...
                                    <h3><span style="color:#fff" class="usage22">53%</span></h3>
                                    <h4 class="m-b-none server1"><span style="color:#8CCA1D">BUY</span></h4>
