                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>Settlement Instructions - Trades</h3>
                                <small>Download settlement instructions</small>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a href="{{ url('download_settlement/xlsx/'.date('Y-m-d')) }}" class="btn btn-warning">Download </a>
                                    </div>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('download_settlement/xlsx/'. str_replace('/', '-', $td->TradeDate)) }}" class="btn btn-warning"><i class="pe-7s-cloud-download c-accent"></i> Download</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
