...
<div class="row clearfix">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select name="route" class="full-width select2_demo_1 form-control" data-init-plugin="select2" data-placeholder="Select Menu">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group required">
								...
								{{ Form::select('parent_id', [ 0 =>  'Parent Menu'] + $menus->pluck('name', 'id')->toArray(),null, ['class'=> "full-width form-control select2_demo_1",'data-placeholder' => "Select menu", 'data-init-plugin' => "select2"]) }}
							</div>
						</div>
