...
use Config;
use TradefiUBA\User;
use TradefiUBA\Invite;
use TradefiUBA\Mail\Invited;
use Illuminate\Http\Request;
use TradefiUBA\Events\UserRoleModified;
use TradefiUBA\Http\Requests\InviteDashboardFormRequest;
use TradefiUBA\Http\Requests\UpdateDashboardFormRequest;
...
class AdministratorDashboardController extends Controller
{
     ...
     *
     * @param  TradefiUBA\Http\Requests\UpdateDashboardFormRequest $request
     * @return Illuminate\Http\Response
     */
     ...
     *
     * @param  TradefiUBA\Http\Requests\InviteDashboardFormRequest $request
     * @return Illuminate\Http\Response
     */
