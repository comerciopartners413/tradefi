...
use Session;
use TradefiUBA\User;
use TradefiUBA\Jobs\UploadAvatar;
use Illuminate\Http\Request;
use TradefiUBA\Http\Requests\ProfileSettingsFormRequest;
...
class ProfileSettingsController extends Controller
{
     ...
     *
     * @param  TradefiUBA\Http\Requests\ProfileSettingsFormRequest $request
     * @param  TradefiUBA\User                                     $user
     * @return Illuminate\Http\Response
     */
