...
use TradefiUBA\Http\Requests\CreateMessageThreadRequest;
...
class MessagesThreadController extends Controller
{
     ...
     *
     * @param  TradefiUBA\Message $message
     ...
     * Submitted from view rendered by TradefiUBA\MessageThreadController
     * Technically creates a 'thread' and a Message.
     *
     * @param  TradefiUBA\Http\Requests\CreateMessageThreadRequest $request
     * @return Illuminate\Http\Response
     */
